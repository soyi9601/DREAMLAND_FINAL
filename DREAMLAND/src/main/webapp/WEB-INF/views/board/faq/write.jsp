        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">공지사항테이블</h4>
              ...
              <form id="frm-blog-register"
                  ...
                  <div>
								  ...
								  <div>
								    <textarea name="boardContents" id="contents"  placeholder="내용을 입력하세요"></textarea>
								  </div>
